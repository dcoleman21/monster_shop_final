...
merchant_user = brian.users.create!(name: 'Megan', address: '123 Main St', city: 'Denver', state: 'CO', zip: 80218, email: 'megan_1@example.com', password: 'securepassword')
discount1 = BulkDiscount.create!(discount_percentage: 5, item_minimun: 6, merchant_id: brian.id)
