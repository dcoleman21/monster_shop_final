...
merchant = User.create!(name: 'Dani Coleman', address: '125 Main St', city: 'Denver', state: 'CO', zip: 80218, email: '1@merchant.com', password: '123', role: 1, merchant_id: brian.id)
